...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ??? 13 11:25:16 2017
# Project:  basic_graph.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile basic_graph.pro
#############################################################################
...
Makefile: basic_graph.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/basic_graph1.0.0/ && $(COPY_FILE) --parents window.h .tmp/basic_graph1.0.0/ && $(COPY_FILE) --parents main.cpp window.cpp init.cpp methods.cpp .tmp/basic_graph1.0.0/ && (cd `dirname .tmp/basic_graph1.0.0` && $(TAR) basic_graph1.0.0.tar basic_graph1.0.0 && $(COMPRESS) basic_graph1.0.0.tar) && $(MOVE) `dirname .tmp/basic_graph1.0.0`/basic_graph1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/basic_graph1.0.0
...
moc_window.cpp: window.h
	/usr/lib64/qt4/bin/moc $(DEFINES) $(INCPATH) window.h -o moc_window.cpp
